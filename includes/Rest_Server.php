...
use COSS\Importers\Zelle_Importer;
use WP_REST_Request;
...
class Rest_Server {
	...
	public function run_widgets_importer( WP_REST_Request $request ) {
		...
		set_theme_mod( 'codeless_content_imported', 'yes' );
	...
	public function run_front_page_migration( WP_REST_Request $request ) {
		...
		$old_theme = get_theme_mod( 'codeless_prev_theme', 'codeless_onboarding_undefined' );
